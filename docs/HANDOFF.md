...
| 架构规范 | `docs/architecture.md` | 四层架构、依赖方向、数据库规范 |
| 编码规范 | `docs/coding.md` | TypeScript/React/CSS/后端编码、验证门禁 |
| API 规范 | `docs/api.md` | 漏斗式错误处理、Result\<T\>、RESTful 约定 |
| 视觉规范 | `docs/visual.md` | Design Token、技术栈约束 |
| 组件规范 | `docs/components.md` | 按钮/表单/弹窗交互规则 |
| 工具规范 | `docs/utils.md` | 消息工具、共享组件清单 |
| 工作流规范 | `docs/workflow.md` | Git 分支、提交、PR 规则 |
